    ...
    <Container fluid className="project-section">
      ...
      <Container>
        <h1 className="project-heading">
          Mes <strong className="purple">Projets </strong> récent
        </h1>
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/Abdennour76/Serhir_Abdennour_2_Booki_122024"
              demoLink="https://abdennour76.github.io/Serhir_Abdennour_2_Booki_122024/"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/Abdennour76/Serhir_Abdennour_5_Kasa_022025"
              demoLink="https://abdennour76.github.io/Serhir_Abdennour_5_Kasa_022025/"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/Abdennour76/Serhir_Abdennour_3_Sophie_Bluel_012025"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/Abdennour76/Serhir_Abdennour_6_MonVieuxGrimoire_032025/tree/main/P7-Dev-Web-livres/backend"
            />
          </Col>
        </Row>
      </Container>
